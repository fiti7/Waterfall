...
$(function () {
    $('#container').highcharts({
        ...
        xAxis: {
            categories: ['/personal/main/home/', '/personal/framework/skeletons/vodacom-skeletons/js/vodacom.0.min.20130906121923.js', '/personal/framework/skeletons/vodacom-skeletons/js/vodacom.1.min.20130906121923.js', '/personal/framework/skeletons/vodacom-skeletons/js/vodacom.2.min.20130906121923.js', '/personal/framework/skeletons/vodacom-skeletons/js/vodacom.0.nonmin.20130906121923.js']
        },
        yAxis: {
            min: 0,
            title: {
        ...
        series: [{
            name: 'John',
            showInLegend: false,
            data: [28, 1042, 1042, 1042, 1042]
        }, {
            name: 'Jane',
            showInLegend: false,
            data: [645, 380, 372, 371, 371]
        }, {
            name: 'Joe',
            showInLegend: false,
            color: 'transparent',
            data: [353, 366, 365, 366, 366]
        }]
    });
});
**/
